...
function listarUsuariosCasa(req, res) {

    console.log("id usuario Testar", usuarioModel.listarUsuariosCasa())
    usuarioModel.listarUsuariosCasa().then(function (resultado) {
        console.log("Passei pelo controller listarUsuariosCasa Then")
        console.log(resultado);
        if (resultado.length > 0) {
            res.status(200).json(resultado);
        } else {
        ...
        function (erro) {
            console.log("Passei pelo controller listarUsuariosCasa catch")
            console.log(erro);
            console.log("Houve um erro ao realizar a consulta! Erro: ", erro.sqlMessage);
            res.status(500).json(erro.sqlMessage);
        }
